import { Wallet, InMemoryWalletRepository, InMemoryContractRepository, RestArkProvider, MultisigTapscript, CSVMultisigTapscript, VtxoScript, SingleKey } from '@arkade-os/sdk'
...
console.log("Matches address generated by Arkade SDK helper?", [await wallet.getBoardingAddress() === address])